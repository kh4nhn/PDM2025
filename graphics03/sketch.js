let characters = [];
let spriteSheets = [];
let frameCounts = 6; // Adjust based on animation frames per action
...
function setup() {
  ...
  let y2 = height - 100;
  characters.push(new Character(x1, y1, spriteSheets[0])); // SpelunkyGuy
  characters.push(new Character(x2, y2, spriteSheets[1])); // Green
}
