...
function setup() {
  ...
  // Connect synth output to filters, then to output
  synth.disconnect();  // Prevents default connection to audio output
  synth.connect(filter);
  filter.connect(bassFilter);
  bassFilter.connect(); // Connects final filter stage to audio output
